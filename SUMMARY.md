...
- [SQL](data/sql/README.md)
    ...
    - [SELECT_01](data/sql/select1.md)
    - [SELECT_02](data/sql/select2.md)
    - [데이터타입](data/sql/datatype.md)

- [MongoDB](data/mongodb/README.md)
- [Airflow](data/airflow/README.md)
- [데이터엔지니어링](data/de/README.md)

## 머신러닝 인프라

- [mlops](mlsystem/mlops/README.md)
- [kubeflow](mlsystem/kubeflow/README.md)
...
- [컴퓨터구조](CS/architecture/README.md)
...
- [MySQL설치 및 삭제](data/sql/mysql_install_remove.md)
- [pyenv 설치 및 설정](pl/python/pyenv.md)
